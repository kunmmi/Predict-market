...
export function WorldCupBanner({ locale }: { locale: Locale }) {
    ...
    <Link href="/markets" style={{ textDecoration: "none", display: "block" }}>
      <div
        style={{
          ...
          boxShadow:
            "0 8px 40px rgba(0,0,0,0.6), 0 0 0 1px rgba(34,197,94,0.1), inset 0 1px 0 rgba(255,255,255,0.04)",
          cursor: "pointer",
      ...
      >
        {/* Grass stripes */}
        <div aria-hidden style={{ position: "absolute", inset: 0, backgroundImage: "repeating-linear-gradient(90deg, transparent, transparent 34px, rgba(255,255,255,0.022) 34px, rgba(255,255,255,0.022) 36px)", pointerEvents: "none" }} />
        {/* Top glow edge */}
        <div aria-hidden style={{ position: "absolute", top: 0, left: 0, right: 0, height: 2, background: "linear-gradient(90deg, transparent, rgba(34,197,94,0.6) 30%, rgba(34,197,94,0.9) 50%, rgba(34,197,94,0.6) 70%, transparent)", pointerEvents: "none" }} />
        {/* Right ambient */}
        ...
        <div style={{ position: "relative", display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 5, fontFamily: "var(--font-mono)", fontSize: "0.5625rem", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: "#4ade80", backgroundColor: "rgba(34,197,94,0.12)", border: "1px solid rgba(34,197,94,0.3)", borderRadius: 100, padding: "3px 10px" }}>
              <span style={{ width: 6, height: 6, borderRadius: "50%", backgroundColor: "#4ade80", boxShadow: "0 0 8px #4ade80", display: "inline-block" }} />
              {t.featured_badge}
            </span>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", paddingTop: 4, borderTop: "1px solid rgba(255,255,255,0.06)" }}>
            {[
              { emoji: "🏆", label: t.chip_winner },
              { emoji: "⚽", label: t.chip_group },
              { emoji: "📊", label: t.chip_yes_no },
              { emoji: "🔓", label: t.chip_open },
            ].map(({ emoji, label }) => (
              <span key={label} style={{ display: "inline-flex", alignItems: "center", gap: 5, fontFamily: "var(--font-sans)", fontSize: "0.6875rem", color: "rgba(255,255,255,0.45)", backgroundColor: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 100, padding: "3px 10px" }}>
