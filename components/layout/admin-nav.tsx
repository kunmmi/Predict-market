...
import {
  ...
  Users, UserCheck, BarChart2, GitBranch, ScrollText, DollarSign, Wallet, Menu, X, Settings, MessageSquare
} from "lucide-react";
...
export function AdminNav({ locale, t }: Props) {
  ...
  const NAV_ITEMS = [
    ...
    { href: "/admin/support",        label: locale === "zh" ? "客服" : "Support", en: "Support", icon: MessageSquare },
